...
from api.views import UserSignUpAndView, UserProfileView, MeUserProfileView, UserSetPasswordView, GetIngredientsViewSet, GetTagsViewSet, RecipesViewSet, UserSubscriptionsView, AddSubView, RecipeInFavoriteView, RecipeInShoppingCartView, LoadShoppingCart
...
urlpatterns = [
    ...
    path('recipes/<int:pk>/favorites/', RecipeInFavoriteView.as_view()),
    path('recipes/<int:pk>/shopping_cart/', RecipeInShoppingCartView.as_view()),
